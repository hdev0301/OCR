...
function sanitize(inputPath, outputPath) {
    ...
    cv.readImage(inputPath, function(err, image) {
        ...
        // Darken the image a tiny bit
        image.addWeighted(image, .7, image, 0);
        let bw = image.adaptiveThreshold(255, 0, 0, 31, 16);
        ...
        bw.rectangle([540 * stretchRatio,1], [110 * stretchRatio, image.height()], BLACK, -1);

        // dilate the white areas (2 iterations)
        bw.dilate(2);
